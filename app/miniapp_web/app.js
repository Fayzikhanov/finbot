(function () {
  ...
  i18n.uz = Object.assign({}, i18n.ru, {
    ...
    home_breakdown_expense: "Xarajatlar taqsimoti",
    home_breakdown_income: "Daromadlar taqsimoti",
    donut_total_period: "Davr bo'yicha jami",
    home_recent_expenses: "So'nggi xarajatlar",
    home_recent_income: "So'nggi daromadlar",
    ...
    profile_info_title: "Shaxsiy ma'lumotlar",
    profile_info_meta_default: "Ism, username va kontaktlar",
    profile_support_title_row: "Yordam",
    profile_support_meta_default: "Dasturchi bilan aloqa va xato haqida xabar",
    profile_rate_title: "Botni baholash",
    profile_rate_meta_default: "Baho va fikr qoldirish",
    ...
    support_dev_title: "Dasturchi bilan aloqa",
    support_dev_meta: "Dasturchiga xabar yozish",
    support_bug_title: "Xato haqida xabar berish",
    support_bug_meta: "Matn va foto (ixtiyoriy)",
    support_message_label: "Xabar",
    support_message_placeholder: "Savol yoki muammoni yozing",
    support_attach_photo: "Foto qo'shish",
    support_clear_photo: "Fotoni tozalash",
    support_photo_limit: "3 tagacha foto qo'shish mumkin (har biri 4 MB gacha)",
    support_compose_hint: "Xabar miniapp ichidan profilingiz nomidan to'g'ridan-to'g'ri dasturchiga yuboriladi.",
    review_current_title: "Joriy baho",
    review_again: "Qayta baholash",
    review_rate_prompt: "Baho qo'ying",
    review_meta_default: "Izoh qoldirish mumkin (ixtiyoriy).",
    review_comment_label: "Izoh",
    review_comment_placeholder: "Nima yoqdi yoki nimani yaxshilash kerak",
    contacts_filled: "To'ldirilgan kontaktlar: {count}",
    profile_rate_current: "Joriy baho: {rating}/5",
    profile_detail_info_title: "Shaxsiy ma'lumotlar",
    profile_detail_info_subtitle: "Profil ma'lumotlaringiz",
    profile_detail_settings_title: "Sozlamalar",
    profile_detail_settings_subtitle: "Til va valyuta",
    profile_detail_support_title: "Yordam",
    profile_detail_support_subtitle: "Dasturchi bilan aloqa va xatolar",
    profile_detail_support_message_title: "Dasturchi bilan aloqa",
    profile_detail_support_message_subtitle: "Xabar yozing",
    profile_detail_support_bug_title: "Xato haqida xabar berish",
    profile_detail_support_bug_subtitle: "Tavsif va foto (ixtiyoriy)",
    profile_detail_review_title: "Botni baholash",
    profile_detail_review_subtitle: "Baho va izoh",
    send_rating: "Bahoni yuborish",
    selected_rating: "Tanlandi: {rating}/5",
    no_comment: "Izohsiz",
    support_message_to_dev: "Dasturchiga xabar",
    support_bug_description: "Xato tavsifi",
    support_bug_placeholder: "Nima bo'ldi, qanday takrorlash mumkin, nimani kutgandingiz",
    support_message_placeholder_compose: "Dasturchiga xabar yozing",
    support_photos_none: "Foto tanlanmagan",
    support_photos_count: "Qo'shilgan foto: {count}/{limit}",
    support_describe_bug: "Xatoni tasvirlab bering",
    support_enter_message: "Xabar kiriting",
    support_sent_bug: "Xato dasturchiga yuborildi",
    support_sent_message: "Xabar yuborildi",
    support_send_failed: "Xabarni yuborib bo'lmadi",
    review_choose_rating: "Bahoni tanlang",
    review_thanks: "Baholaganingiz uchun rahmat",
    review_send_failed: "Bahoni yuborib bo'lmadi",
    profile_subtitle_fallback: "Telegram ma'lumotlari",
    profile_user_fallback: "Foydalanuvchi",
    profile_user_number: "Foydalanuvchi {id}",
    not_specified: "Ko'rsatilmagan",
    profile_partial_loaded: "Profil qisman yuklandi (serversiz)",
    other: "Boshqa",
    language: "Til",
  ...
  i18n.en = Object.assign({}, i18n.ru, {
    ...
    home_breakdown_expense: "Expense breakdown",
    home_breakdown_income: "Income breakdown",
    donut_total_period: "Total for period",
    home_recent_expenses: "Recent expenses",
    home_recent_income: "Recent income",
    view_all: "View all",
    save: "Save",
    send: "Send",
    close: "Close",
    ...
    profile_info_meta_default: "Name, username and contacts",
    profile_support_title_row: "Support",
    profile_support_meta_default: "Contact developer and bug report",
    profile_rate_title: "Rate the bot",
    profile_rate_meta_default: "Leave a rating and review",
    ...
    support_dev_title: "Contact developer",
    support_dev_meta: "Send a message to the developer",
    support_bug_title: "Report a bug",
    support_bug_meta: "Text and photos (optional)",
    support_message_label: "Message",
    support_message_placeholder: "Describe your question or issue",
    support_attach_photo: "Attach photo",
    support_clear_photo: "Clear photo",
    support_photo_limit: "You can add up to 3 photos (up to 4 MB each)",
    support_compose_hint: "The message will be sent to the developer directly from the miniapp on behalf of your profile.",
    review_current_title: "Current rating",
    review_again: "Rate again",
    review_rate_prompt: "Give a rating",
    review_meta_default: "You can leave a comment (optional).",
    review_comment_label: "Comment",
    review_comment_placeholder: "What did you like and what can be improved",
    contacts_filled: "Contacts filled: {count}",
    profile_rate_current: "Current rating: {rating}/5",
    profile_detail_info_title: "Personal information",
    profile_detail_info_subtitle: "Your profile details",
    profile_detail_settings_title: "Settings",
    profile_detail_settings_subtitle: "Language and currency",
    profile_detail_support_title: "Support",
    profile_detail_support_subtitle: "Developer contact and issues",
    profile_detail_support_message_title: "Contact developer",
    profile_detail_support_message_subtitle: "Write a message",
    profile_detail_support_bug_title: "Report a bug",
    profile_detail_support_bug_subtitle: "Description and photos (optional)",
    profile_detail_review_title: "Rate the bot",
    profile_detail_review_subtitle: "Rating and comment",
    send_rating: "Send rating",
    selected_rating: "Selected: {rating}/5",
    no_comment: "No comment",
    support_message_to_dev: "Message to developer",
    support_bug_description: "Bug description",
    support_bug_placeholder: "What happened, how to reproduce it, and what you expected to see",
    support_message_placeholder_compose: "Write a message to the developer",
    support_photos_none: "No photos selected",
    support_photos_count: "Photos added: {count}/{limit}",
    support_describe_bug: "Describe the bug",
    support_enter_message: "Enter a message",
    support_sent_bug: "Bug report sent to the developer",
    support_sent_message: "Message sent",
    support_send_failed: "Failed to send the message",
    review_choose_rating: "Choose a rating",
    review_thanks: "Thanks for your rating",
    review_send_failed: "Failed to send the rating",
    profile_subtitle_fallback: "Telegram data",
    profile_user_fallback: "User",
    profile_user_number: "User {id}",
    not_specified: "Not specified",
    profile_partial_loaded: "Profile loaded partially (without server)",
    other: "Other",
  ...
  function isPersonalMode() {
    return state.workspaceType === "personal";
  }

  function applyPersonalModeUI() {
    const personal = isPersonalMode();
    const lang = currentLanguageCode();
    // Hide scope selector on home screen (just show "Главная")
    if (els.scopeWrap) els.scopeWrap.classList.toggle("hidden", personal);
    // Hide "Перевод" quick action button
    if (els.quickAddTransferBtn) els.quickAddTransferBtn.classList.toggle("hidden", personal);
    // Hide "Семейные переводы" card on home screen
    const familyTransfersCard = els.familyTransfersValue ? els.familyTransfersValue.closest(".card-like") : null;
    if (familyTransfersCard) familyTransfersCard.classList.toggle("hidden", personal);
    // Hide "Транзакция / Перевод средств внутри семьи" mode row on add screen
    const addModeRow = document.getElementById("addModeRow");
    if (addModeRow) addModeRow.classList.toggle("hidden", personal);
    // Hide "Переводы" filter on transactions page
    const transferFilterBtn = els.transactionsFilters
      ? els.transactionsFilters.querySelector('[data-tx-filter="transfer"]')
      : null;
    if (transferFilterBtn) transferFilterBtn.classList.toggle("hidden", personal);
    // Update analytics trend title
    if (els.analyticsTrendTitle) {
      if (personal) {
        setNodeText(els.analyticsTrendTitle, lang === "ru" ? "Динамика расходов" : (lang === "uz" ? "Xarajatlar dinamikasi" : "Expense trend"));
      } else {
  ...
  function renderScreenChromeVisuals() {
    ...
    if (els.screenTitle) {
      els.screenTitle.classList.remove("home-scope-trigger");
  ...
  function renderBalanceTrendChart(memberBuckets, participantRows, startIso, endIso) {
    ...
    els.balanceTrendLegend.innerHTML = series.rows
      .map((row) => {
        const legendLabel = isPersonalMode()
          ? (currentLanguageCode() === "ru" ? "Расходы" : (currentLanguageCode() === "uz" ? "Xarajatlar" : "Expenses"))
          : row.label;
        return `
        <span class="trend-legend-item trend-legend-item-user">
          <span class="trend-legend-dot" style="background:${row.color}"></span>
          <span class="trend-legend-user-name">${escapeHtml(legendLabel)}</span>
  ...
  function applyOverviewMeta(payload) {
    if (payload && payload.workspace_type) {
      state.workspaceType = String(payload.workspace_type);
    }
  ...
  function renderAnalyticsForecast(report) {
    ...
    const familyLabel = isPersonalMode()
      ? (lang === "ru" ? "Итого" : (lang === "uz" ? "Jami" : "Total"))
      : (lang === "ru" ? "Семья (всё)" : (lang === "uz" ? "Oila (hammasi)" : "Family (total)"));
    ...
    if (hasExpenseData) {
      if (isPersonalMode()) {
        summaryText = lang === "ru"
          ...
          : (lang === "uz"
            ? `Hozirgi sur'at saqlansa, xarajatlar ~ ${fmtMoney(projected, false)} bo'ladi`
            : `If the current pace continues, expenses will be about ${fmtMoney(projected, false)}`);
      } else {
        summaryText = lang === "ru"
    ...
    if (!hasExpenseData) {
      ...
      if (isPersonalMode()) {
        noteText = lang === "ru"
          ? "При текущем темпе бюджет остаётся в плюсе"
          : (lang === "uz" ? "Hozirgi sur'atda byudjet ijobiy qoladi" : "At the current pace the budget stays positive");
      } else {
        noteText = lang === "ru"
    ...
    els.analyticsForecast.innerHTML = `
      <div class="analytics-forecast-card family ${forecastWarn ? "warning" : ""}">
        ...
        ${participantsForecast.length && hasExpenseData && !isPersonalMode() ? `
  ...
  function renderAnalyticsTrendChanges(report) {
    ...
    if (isPersonalMode()) {
      ...
      els.analyticsTrendChanges.classList.add("single");
      els.analyticsTrendChanges.innerHTML = `
        <div class="analytics-delta-card analytics-member-card is-primary">
          <div class="analytics-member-card-head">
            <div class="analytics-member-card-title-wrap">
              <span class="analytics-member-card-icon is-primary">${lucideSvg("receipt", { width: 14, height: 14 })}</span>
              <span class="analytics-delta-label analytics-member-card-name">${escapeHtml(avgCheckLabel)}</span>
            </div>
          </div>
          <div class="analytics-delta-value">${fmtMoney((row && row.avgCheck) || 0, false)}</div>
          <div class="analytics-member-card-meta">
            <span>${escapeHtml(txLabel((row && row.txCount) || 0))}</span>
            <span aria-hidden="true">•</span>
            <span>${fmtMoney((row && row.expense) || 0, false)} ${lang === "ru" ? "всего" : (lang === "uz" ? "jami" : "total")}</span>
          </div>
        </div>
      `;
      return;
  ...
  function renderAnalyticsParticipants(report) {
    ...
    if (isPersonalMode()) {
      ...
      const parentSection = els.analyticsParticipants.closest("section");
